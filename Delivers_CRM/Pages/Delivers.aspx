...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <asp:DetailsView ID="DVInsertDelivers" runat="server" AutoGenerateRows="False" DataKeyNames="Deliver_ID" DataSourceID="SqlDataSourceDelivers" DefaultMode="Insert" Height="50px" Width="387px">
        <Fields>
