...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:DetailsView ID="DVAddNewCustomer" runat="server" Height="50px" Width="380px" AutoGenerateRows="False" DataKeyNames="ID" DefaultMode="Insert" OnItemInserting="DVAddNewCustomer_ItemInserting" OnModeChanging="DVAddNewCustomer_ModeChanging">
            <Fields>
                ...
                <asp:TemplateField HeaderText="שעות פעילות" SortExpression="Bussines_WorkingHouers">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="תאריך הצטרפות" SortExpression="Bussines_CustomerAddDate" InsertVisible="False">
                    <EditItemTemplate>
    ...
    <div id="DivSearchResult" runat="server" style="width: 50%; float: right;">
        ...
        <asp:DetailsView ID="DVSearchResult" runat="server" AutoGenerateRows="False" DataKeyNames="ID" DataSourceID="SqlDataSourceSearchResult" Height="50px" Width="313px">
            <Fields>
                ...
                <asp:TemplateField HeaderText="Bussines_LogoName" SortExpression="Bussines_LogoName" Visible="False">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Bussines_LogoType" SortExpression="Bussines_LogoType" Visible="False">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="תאריך הצטרפות" SortExpression="Bussines_CustomerAddDate">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox12" runat="server" Text='<%# Bind("Bussines_CustomerAddDate") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <InsertItemTemplate>
                ...
                <asp:CommandField ButtonType="Button" ShowEditButton="True" CancelText="ביטול" DeleteText="מחק" EditText="ערוך" InsertText="הוסף" NewText="חדש" SelectText="בחר" UpdateText="עדכן" />
            </Fields>
        </asp:DetailsView>
    </div>
